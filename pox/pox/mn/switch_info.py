...
1. Run the POX Controller without the l2_learning component
 ./pox.py log.level --INFO samples.pretty_log mn.switch_info

Note that h1 ping h2 will fail

2. Add the forwarding.l2_learning component
 ./pox.py log.level --INFO samples.pretty_log forwarding.l2_learning mn.switch_info
